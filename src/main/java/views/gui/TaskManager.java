...
public class TaskManager extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TaskManager frame = new TaskManager(new User("asdf", "asdf".toCharArray()),null);
	...
	public static TaskManager getInstance(User currentUser, Event event) {
		if(instance == null) {
			instance = new TaskManager(currentUser, event);
		} else {
			instance.dispose();
			instance = new TaskManager(currentUser, event);
		}
     ...
     */
	private TaskManager(User currentUser, Event event) {
        ...
        if(isEditing()==false){
            ...
            repeatUntilDate.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent arg0) {
                    ...
                    }, TaskManager.this.currentUser).setVisible(true);
                }
            });
